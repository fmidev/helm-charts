...
| `secretProvider`                                 | Option to use secret provider instead of passing base64 encoded database connection string as warnings.db_secret _(aws\|azure\|gcp\|vault)_               |                                                                             |
...
| `warnings.customConfigurationLocation`           | Where custom configurations are located _(local\|s3)_                                                                                                     | `local`                                                                     |
