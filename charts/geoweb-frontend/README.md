...
| `ingress.server-snippet` | Used to configure Document-policy:js-profiling header to the root file of the geoweb application. This is required by Sentry to enable javascript profiling |
