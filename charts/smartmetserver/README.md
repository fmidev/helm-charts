...
```bash
helm install --dry-run --debug -n smartmetserver smartmetserver deploy/helm/smartmetserver
```
...
```bash
helm upgrade -i -n smartmetserver smartmetserver portainer/portainer
